...
public static get API_ENDPOINT(): string { return window.location.hostname == 'localhost' || window.location.hostname.match(/0/) ? 'http://0.0.0.0:8080/api' : 'https://rednotebook.herokuapp.com/api' }
